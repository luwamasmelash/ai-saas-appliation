...
The article must be between ${selectedLength.min} and ${selectedLength.max} words.
Do not write fewer than ${selectedLength.min} words.
Do not write more than ${selectedLength.max} words.
